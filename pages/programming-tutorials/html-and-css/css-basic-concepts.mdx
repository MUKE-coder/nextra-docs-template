...
**Usage:** Commonly used for setting a solid color background for elements
...
Description: Controls how the background image is repeated
...
**Usage:** Prevents the background image from repeating, ensuring it appears only once.
